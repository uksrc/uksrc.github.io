...
Making research data FAIR (Findable, Accessible, Interoperable and Reusable) is not only a technical challenge. It also involves the human and social side of research: professional practice, professional identity and agency, or the actions humans take in response to changes in their situation and context. 
This project will use social science approaches to make hidden social and cultural challenges and barriers to data sharing visible. This will enable co-design of evidence-based interventions tailored for the respective research community’s needs. We will pilot a FAIR Data Accelerator (adapting the approach used by technology start-ups) to create a discipline-agnostic platform that could help others adopt this approach more widely.
