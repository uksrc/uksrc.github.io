---
title: "The societal impact of radio astronomy"
type: pages
permalink: /societal-impact/
layout: single
toc: true
...
Astronomy is one of the oldest sciences, and radio astronomy one of the youngest. Together they tell us where we come from and what the Universe is made of. But the case for building telescopes like the Square Kilometre Array (SKA) does not rest on curiosity alone. The work needed to design, build and run them produces skills, technology and partnerships that reach far beyond astronomy, and the UK SKA Regional Centre (UKSRC) is part of that story.
...
* **Big data, cloud and AI.** The SKA will produce hundreds of petabytes of data every year. Handling it is driving advances in cloud computing, data management and machine learning that can be applied in healthcare, climate science and industry. This is exactly the kind of work the UKSRC carries out, and our [knowledge exchange](/technical-challenges/) activities are designed to pass those methods on to UK industry and other research fields.
...
Hosting the SKAO brings measurable benefits to the UK. The SKAO's Global Headquarters sits next to the historic Jodrell Bank Observatory in Cheshire, a UNESCO World Heritage Site. According to the [SKAO](https://www.skao.int/en/partners/skao-members/396/united-kingdom):
...
They also help to spread scientific capacity. The Development in Africa with Radio Astronomy (DARA) programme, a UK–South Africa partnership running since 2015, has trained more than 320 students, several of whom now lead teaching at African universities. More broadly, the [International Astronomical Union's Office of Astronomy for Development](https://astro4dev.org/) uses astronomy as a tool to support education, skills and economic development. Since 2013 it has funded more than 200 projects and reached over two million people in 112 countries.

## Inspiring the next generation ##
Few subjects draw people into science the way astronomy does. A picture of a galaxy or a question about whether we are alone can be the first step towards a career in engineering, computing or research. The UKSRC supports training, outreach and public engagement that bring radio astronomy and the work of the SKA to students, teachers and the wider public across the UK.

## The UKSRC's part in this ##
The UK SKA Regional Centre is where much of this comes together in the UK. We are building the data infrastructure that will let researchers store, access and analyse SKA data; developing the skills of the people who will use it; keeping that data and software open and reusable through [FAIR principles](/fair-data-pilot/); and sharing the technology and methods we develop with industry and other fields. Through a national programme, we also support UK astronomers using the SKA's precursor and pathfinder telescopes, such as MeerKAT, LOFAR and e-MERLIN, so the community can build skills and do new science now, ahead of the SKA itself. In doing so, the UKSRC turns a world-leading telescope into lasting benefits for science and for society.

---

### References and further reading ###
* SKAO, [The United Kingdom and the SKAO](https://www.skao.int/en/partners/skao-members/396/united-kingdom) (UK membership, contracts and economic benefits)
* CSIRO, [What is radio astronomy?](https://www.csiro.au/en/research/technology-space/astronomy-space/what-is-radio-astronomy) and [bringing fast wireless connectivity to the world](https://www.csiro.au/en/research/technology-space/it/wireless-lan) (the origins of Wi-Fi)
* National Radio Astronomy Observatory, [Invisible Realms Revealed: Radio Technology Expands Frontiers of Astronomy and Medicine](https://public.nrao.edu/news/invisible-realms-revealed/)
* [Development in Africa with Radio Astronomy (DARA)](https://www.dara-project.org/)
* [IAU Office of Astronomy for Development](https://astro4dev.org/)
