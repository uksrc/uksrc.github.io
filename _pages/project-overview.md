...
---
The UK SKA Regional Centre Development Project is organised into five work packages, each responsible for a different part of building and running the UKSRC:
...
* WP2 Technical Development: encompasses technical development activities required to deliver the UKSRC, in coordination with SRCNet prototyping team developments.
    * Hardware and software enabling technologies: cloud; authentication, authorisation and identity management; data logistics; architecture and optimisation.
    * Developing a FAIR Data Archive
    * Science analysis platform development
* WP3 Community Support, Engagement and Onboarding: links SRC development with the scientific user community, through programmes of co-design and early adoption of services. 
